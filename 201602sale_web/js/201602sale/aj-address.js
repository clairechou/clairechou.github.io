...
//初始化
function init_address_1(){
    	
    var zone1_1 = document.getElementById('zone1_1');
    var zone2_1 = document.getElementById('zone2_1');
    
    zone1_1.options.add(first());
	zone2_1.options.add(first());
	...
	for(var i in zip[0]){
        ...
        o.text=zip[0][i];
        o.value=zip[0][i];
        zone1_1.options.add(o);
	}
    
    //區
	zone1_1.onchange=function(){
	   
        document.getElementById('zipcode_1').value = "";
		...
		if(this.selectedIndex>0){
    		for(var i in zip[this.value]){                
                ...
                o.text = i;
    			o.value = i;
    			zone2_1.options.add(o);
    		}
        }
	};
    
    //郵遞區號
    zone2_1.onchange=function(){
		if(this.selectedIndex>0)
            document.getElementById('zipcode_1').value = zip[zone1_1.value][zone2_1.value];
	};
}

function init_address_2(){
    	
    var zone1_2 = document.getElementById('zone1_2');
    var zone2_2 = document.getElementById('zone2_2');
    
    zone1_2.options.add(first());
	zone2_2.options.add(first());
	...
	for(var i in zip[0]){
        ...
        o.text=zip[0][i];
        o.value=zip[0][i];
        zone1_2.options.add(o);
	}
    
    //區
	zone1_2.onchange=function(){
	   
        document.getElementById('zipcode_2').value = "";
		...
		if(this.selectedIndex>0){
    		for(var i in zip[this.value]){                
                ...
                o.text = i;
    			o.value = i;
    			zone2_2.options.add(o);
    		}
        }
	};
    
    //郵遞區號
    zone2_2.onchange=function(){
		if(this.selectedIndex>0)
            document.getElementById('zipcode_2').value = zip[zone1_2.value][zone2_2.value];
	};
}

function init_address_3(){
    	
    var zone1_3 = document.getElementById('zone1_3');
    var zone2_3 = document.getElementById('zone2_3');
    
    zone1_3.options.add(first());
	zone2_3.options.add(first());
	...
	for(var i in zip[0]){
        ...
        o.text=zip[0][i];
        o.value=zip[0][i];
        zone1_3.options.add(o);
	}
    
    //區
	zone1_3.onchange=function(){
	   
        document.getElementById('zipcode_3').value = "";
		...
		if(this.selectedIndex>0){
    		for(var i in zip[this.value]){                
                ...
                o.text = i;
    			o.value = i;
    			zone2_3.options.add(o);
    		}
        }
	};
    
    //郵遞區號
    zone2_3.onchange=function(){
		if(this.selectedIndex>0)
            document.getElementById('zipcode_3').value = zip[zone1_3.value][zone2_3.value];
	};
}
